  ...
  return (
    ...
    <div className="row footer-top">
      <div className="column large-4 medium-5 tab-full">
        ...
        {/* <!-- footer-logo --> */}
        <p>
          Laborum ad explicabo. Molestiae voluptates est. Quisquam
          labore tenetur et assumenda voluptatibus a beatae. Rerum odio
          ducimus reprehenderit sit animi laborum nostrum dolorum animi
          voluptates est voluptatibus a beatae.
        </p>
      </div>
